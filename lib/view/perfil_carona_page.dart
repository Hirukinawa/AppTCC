...
import 'package:uniride/view/avaliacao_page.dart';
import 'package:uniride/view/avaliacoes_page.dart';
import 'package:uniride/view/editar_avaliacao_page.dart';
import 'package:url_launcher/url_launcher.dart';

class PerfilCaronaPage extends StatefulWidget {
  final Aluno alunoPerfil;
  final Aluno aluno;
  final bool isPassageiro;
  const PerfilCaronaPage(
      {Key? key,
      required this.alunoPerfil,
      required this.aluno,
      required this.isPassageiro})
      : super(key: key);

  @override
  _PerfilCaronaPageState createState() => _PerfilCaronaPageState();
}

class _PerfilCaronaPageState extends State<PerfilCaronaPage> {
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    (!widget.isPassageiro)
                        ? const SizedBox()
                        : (foiAvaliado(widget.alunoPerfil) == true)
                            ? Column(
                                children: [
                                  ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      var result =
                                        ...
                                        MaterialPageRoute(
                                          builder: (_) => EditarAvaliacaoPage(
                                            avaliado: widget.alunoPerfil,
                                            avaliador: widget.aluno,
                                          ),
                                        ),
                                      );
